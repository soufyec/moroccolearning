...
{ cat:"Les gens", items:[
  ...
  { id:"w3", fr:"un garçon", phon:"weld", ar:"ولد" },
  ...
  { id:"w9", fr:"les invités", phon:"ddyaf", ar:"الضياف" },
...
{ cat:"À table", items:[
  ...
  { id:"w23", fr:"le thé à la menthe", phon:"atay b nne3na3", ar:"أتاي بالنعناع" },
  { id:"w24", fr:"le café", phon:"lqhwa", ar:"القهوة" },
...
{ cat:"La maison", items:[
  ...
  { id:"w56", fr:"la clé", phon:"ssarout", ar:"الساروت" },
  { id:"w57", fr:"le lit", phon:"nnamousiya", ar:"الناموسية" },
  { id:"w58", fr:"la couverture", phon:"lbttaniya", ar:"البطانية" },
  { id:"w59", fr:"les vêtements", phon:"l7wayj", ar:"الحوايج" },
  { id:"w60", fr:"les chaussures", phon:"ssbbat", ar:"الصباط" },
  { id:"w61", fr:"le téléphone", phon:"tilifoun", ar:"تيليفون" },
  { id:"w62", fr:"l’argent", phon:"lflous", ar:"الفلوس" },
  { id:"w63", fr:"un cadeau", phon:"cadeau", ar:"كادو", note:"Beaucoup d’objets modernes gardent leur nom français. En cas de doute, dis le mot français." },
  { id:"w64", fr:"la lumière", phon:"ddaw", ar:"الضو" }
]},
{ cat:"Le temps", items:[
  ...
  { id:"w74", fr:"après", phon:"men be3d", ar:"من بعد" },
  ...
  { id:"w82", fr:"une année", phon:"3am", ar:"عام" },
  { id:"w83", fr:"tôt", phon:"bekri", ar:"بكري" },
...
{ cat:"Dehors", items:[
  ...
  { id:"w91", fr:"le marché", phon:"ssouq", ar:"السوق" },
  { id:"w92", fr:"l’ancienne médina", phon:"lmdina lqdima", ar:"المدينة القديمة" },
  ...
  { id:"w98", fr:"le café (le lieu)", phon:"lqahwa", ar:"القهوة" },
  { id:"w99", fr:"la pharmacie", phon:"ffarmasyan", ar:"الفارماسيان" },
  { id:"w100", fr:"l’hôpital", phon:"ssbitar", ar:"السبيطار" },
  { id:"w101", fr:"la mosquée", phon:"jjame3", ar:"الجامع" },
  { id:"w102", fr:"le hammam", phon:"l7emmam", ar:"الحمام" },
  { id:"w103", fr:"la plage", phon:"chchatt", ar:"الشط" }
]},
{ cat:"Comment c’est", items:[
  { id:"w110", fr:"bien, bon", phon:"mezyan", ar:"مزيان", note:"Au féminin : <b>mezyana</b>. La règle vaut pour presque tous les adjectifs : on ajoute a." },
  ...
  { id:"w121", fr:"fatigué", phon:"3ayyan", ar:"عيان" },
  { id:"w122", fr:"content", phon:"ferhan", ar:"فرحان" },
  { id:"w123", fr:"triste, contrarié", phon:"mqelleq", ar:"مقلق" },
  { id:"w124", fr:"gentil, charmant", phon:"drif", ar:"ظريف" },
  { id:"w125", fr:"délicieux", phon:"bnin", ar:"بنين" },
  { id:"w126", fr:"plein, rassasié", phon:"chab3an", ar:"شبعان" },
  { id:"w127", fr:"propre", phon:"nqi", ar:"نقي" },
  { id:"w128", fr:"loin", phon:"b3id", ar:"بعيد" },
  { id:"w129", fr:"près", phon:"qrib", ar:"قريب" }
]},
{ cat:"Le corps et la santé", items:[
  { id:"w140", fr:"la tête", phon:"rras", ar:"الراس" },
  ...
  { id:"w145", fr:"le cœur", phon:"lqelb", ar:"القلب" },
  { id:"w146", fr:"j’ai mal à la tête", phon:"kaydrni rrasi", ar:"كيضرني راسي" },
  { id:"w147", fr:"je suis malade", phon:"ana mrida", ar:"أنا مريضة" },
  { id:"w148", fr:"le médicament", phon:"ddwa", ar:"الدوا" },
  { id:"w149", fr:"la santé", phon:"ss77a", ar:"الصحة" }
]},
{ cat:"Les petits mots qui relient", items:[
  ...
  { id:"w166", fr:"aussi", phon:"7ta ana", ar:"حتى أنا", note:"Littéralement moi aussi. <b>7ta nta</b> = toi aussi." },
  { id:"w167", fr:"ici", phon:"hna", ar:"هنا" },
  { id:"w168", fr:"là-bas", phon:"temma", ar:"تما" },
  ...
  { id:"w174", fr:"peut-être", phon:"waqila", ar:"واقيلا" },
  ...
  { id:"w178", fr:"comme ça", phon:"hakka", ar:"هاكا" },
  { id:"w179", fr:"seulement", phon:"ghir", ar:"غير" }
]}
];

const VERBES = [
{ id:"v1", fr:"vouloir, aimer", note:"<b>bghit</b> a l’air d’un passé mais veut dire je veux, maintenant. <b>kanbghi</b> veut dire j’aime.", forms:[
  { l:"je veux", phon:"bghit", ar:"بغيت" },
  { l:"tu veux (à une femme)", phon:"bghiti", ar:"بغيتي" },
...
{ id:"v2", fr:"manger", forms:[
  ...
  { l:"tu manges (à une femme)", phon:"katakli", ar:"كتاكلي" },
  { l:"j’ai mangé", phon:"klit", ar:"كليت" },
  { l:"je vais manger", phon:"ghadi nakoul", ar:"غادي ناكل" },
  { l:"mange ! (à une femme)", phon:"kouli", ar:"كلي" } ]},
{ id:"v3", fr:"boire", forms:[
  ...
  { l:"bois ! (à une femme)", phon:"chrbi", ar:"شربي" } ]},
{ id:"v4", fr:"aller", forms:[
  { l:"je vais (d’habitude)", phon:"kanmchi", ar:"كنمشي" },
  { l:"je suis allée", phon:"mchit", ar:"مشيت" },
  { l:"je vais y aller", phon:"ghadi nemchi", ar:"غادي نمشي" },
  { l:"tu vas où ? (à une femme)", phon:"fin ghadya ?", ar:"فين غادية؟" },
...
{ id:"v5", fr:"venir", forms:[
  ...
  { l:"viens ! (à une femme)", phon:"aji", ar:"أجي" },
...
{ id:"v6", fr:"faire", forms:[
  ...
  { l:"qu’est-ce que tu fais ? (à une femme)", phon:"chnou katdiri ?", ar:"شنو كتديري؟" } ]},
{ id:"v7", fr:"dire", forms:[
  { l:"je dis", phon:"kangoul", ar:"كنقول" },
  { l:"j’ai dit", phon:"gult", ar:"كلت" },
  { l:"dis-moi (à une femme)", phon:"gouli liya", ar:"قولي ليا" },
  { l:"comment on dit ?", phon:"kifach kaygoulou ?", ar:"كيفاش كيقولو؟" } ]},
{ id:"v8", fr:"parler", forms:[
  { l:"je parle", phon:"kanhder", ar:"كنهضر" },
  { l:"j’ai parlé", phon:"hdert", ar:"هضرت" },
  { l:"parle doucement (à une femme)", phon:"hdri b chwiya", ar:"هضري بشوية" } ]},
{ id:"v9", fr:"comprendre", forms:[
  ...
  { l:"tu as compris ? (à une femme)", phon:"fhemti ?", ar:"فهمتي؟" } ]},
{ id:"v10", fr:"savoir, connaître", forms:[
  { l:"je sais, je connais", phon:"kan3ref", ar:"كنعرف" },
  { l:"je ne sais pas", phon:"ma kan3refch", ar:"ما كنعرفش" },
  { l:"tu sais ? (à une femme)", phon:"kat3rfi ?", ar:"كتعرفي؟" } ]},
{ id:"v11", fr:"pouvoir", forms:[
  { l:"je peux", phon:"nqder", ar:"نقدر" },
  { l:"je ne peux pas", phon:"ma nqderch", ar:"ما نقدرش" },
  { l:"tu peux ? (à une femme)", phon:"tqdri ?", ar:"تقدري؟" } ]},
{ id:"v12", fr:"donner", forms:[
  { l:"donne-moi (à une femme)", phon:"3tini", ar:"عطيني" },
  { l:"j’ai donné", phon:"3tit", ar:"عطيت" },
...
{ id:"v18", fr:"acheter", forms:[
  { l:"j’achète", phon:"kanchri", ar:"كنشري" },
  { l:"j’ai acheté", phon:"chrit", ar:"شريت" },
  { l:"je veux acheter", phon:"bghit nchri", ar:"بغيت نشري" } ]},
{ id:"v19", fr:"travailler", forms:[
  { l:"je travaille", phon:"kankhdem", ar:"كنخدم" },
  { l:"j’ai travaillé", phon:"khdemt", ar:"خدمت" },
  { l:"tu travailles où ? (à une femme)", phon:"fin katkhedmi ?", ar:"فين كتخدمي؟" } ]},
...
{ id:"v21", fr:"aider", forms:[
  ...
  { l:"aide-moi (à une femme)", phon:"3awnini", ar:"عاونيني" } ]},
...
{ id:"v23", fr:"oublier", forms:[
  { l:"j’ai oublié", phon:"nsit", ar:"نسيت" },
  { l:"je vais oublier", phon:"ghadi nensa", ar:"غادي ننسى" },
  { l:"n’oublie pas (à une femme)", phon:"ma tnsaych", ar:"ما تنسايش" } ]},
{ id:"v24", fr:"plaire", note:"On ne dit pas j’aime ça mais ça m’a plu : <b>3jebni</b>. C’est la tournure la plus utilisée du quotidien.", forms:[
  { l:"ça m’a plu, j’aime ça", phon:"3jebni", ar:"عجبني" },
  { l:"ça ne m’a pas plu", phon:"ma 3jebnich", ar:"ما عجبنيش" },
  { l:"ça te plaît ?", phon:"3ejbek ?", ar:"عجبك؟" } ]}
];

const MOULES = [
{ id:"x1", fr:"Je veux ___", phon:"bghit ___", note:"Le moule le plus rentable de tous. Colle n’importe quel mot derrière.", ex:[
  { fr:"Je veux du thé", phon:"bghit atay", ar:"بغيت أتاي" },
...
{ id:"x2", fr:"Je veux (faire) ___", phon:"bghit n___", note:"Devant un verbe, on met <b>n</b> : bghit + n + le verbe.", ex:[
  { fr:"Je veux aller au marché", phon:"bghit nemchi l ssouq", ar:"بغيت نمشي للسوق" },
...
{ id:"x3", fr:"Je vais ___ (bientôt)", phon:"ghadi n___", note:"<b>ghadi</b> est le futur. Il ne change jamais, seul le verbe change.", ex:[
...
{ id:"x4", fr:"Je ___ (tous les jours)", phon:"kan___", note:"<b>kan</b> devant le verbe = ce que je fais d’habitude. <b>kat</b> = ce que tu fais.", ex:[
  { fr:"Je mange des légumes", phon:"kanakoul lkhodra", ar:"كناكل الخضرة" },
  { fr:"J’habite à Paris", phon:"kanskoun f bariz", ar:"كنسكن فباريز" },
  { fr:"Je travaille beaucoup", phon:"kankhdem bezzaf", ar:"كنخدم بزاف" } ]},
{ id:"x5", fr:"Je ne ___ pas", phon:"ma ___ ch", note:"La négation encadre le verbe, exactement comme ne pas en français.", ex:[
...
{ id:"x6", fr:"J’ai ___", phon:"3endi ___", note:"Il n’y a pas de verbe avoir : <b>3endi</b> veut dire chez moi. <b>3endek</b> = chez toi.", ex:[
  { fr:"J’ai une sœur", phon:"3endi khti we7da", ar:"عندي ختي وحدة" },
...
{ id:"x7", fr:"Est-ce que ___ ?", phon:"wach ___ ?", note:"<b>wach</b> ouvre une question fermée. Le reste de la phrase ne bouge pas.", ex:[
  { fr:"Est-ce que tu veux du thé ?", phon:"wach bghiti atay ?", ar:"واش بغيتي أتاي؟" },
  { fr:"Est-ce que c’est loin ?", phon:"wach b3id ?", ar:"واش بعيد؟" },
  { fr:"Est-ce que c’est à toi ?", phon:"wach hada dyalek ?", ar:"واش هادا ديالك؟" } ]},
{ id:"x8", fr:"Où est ___ ?", phon:"fin kayn ___ ?", note:"<b>kayn</b> pour un mot masculin, <b>kayna</b> pour un féminin, <b>kaynin</b> pour un pluriel.", ex:[
  { fr:"Où est le marché ?", phon:"fin kayn ssouq ?", ar:"فين كاين السوق؟" },
  { fr:"Où sont les toilettes ?", phon:"fin kayna ttwalit ?", ar:"فين كاينة التواليت؟" },
  { fr:"Où sont les enfants ?", phon:"fin kaynin ddrari ?", ar:"فين كاينين الدراري؟" } ]},
...
{ id:"x10", fr:"Combien ___ ?", phon:"ch7al ___ ?", ex:[
  { fr:"Ça coûte combien ?", phon:"ch7al hada ?", ar:"شحال هادا؟" },
  { fr:"Tu as quel âge ?", phon:"ch7al f 3emrek ?", ar:"شحال فعمرك؟" },
...
{ id:"x11", fr:"Pourquoi ___ ? Parce que ___", phon:"3lach ___ ? / 7it ___", ex:[
  { fr:"Pourquoi comme ça ?", phon:"3lach hakka ?", ar:"علاش هاكا؟" },
  { fr:"Parce que je suis fatiguée", phon:"7it ana 3ayyana", ar:"حيت أنا عيانة" },
  { fr:"Parce que je t’aime", phon:"7it kanbghik", ar:"حيت كنبغيك" } ]},
{ id:"x12", fr:"___ à moi, ___ à toi", phon:"___ dyali / dyalek", note:"<b>dyal</b> = de. dyali, dyalek, dyalou (à lui), dyalkoum (à vous).", ex:[
  { fr:"C’est mon téléphone", phon:"hada tilifoun dyali", ar:"هادا تيليفون ديالي" },
  { fr:"Votre maison est belle", phon:"ddar dyalkoum zwina", ar:"الدار ديالكم زوينة" },
  { fr:"C’est le thé de maman", phon:"hada atay dyal mama", ar:"هادا أتاي ديال ماما" } ]},
{ id:"x13", fr:"C’est ___", phon:"hada / hadi ___", note:"<b>hada</b> pour un mot masculin, <b>hadi</b> pour un féminin. Pas de verbe être.", ex:[
  { fr:"C’est délicieux", phon:"hadi bnina", ar:"هادي بنينة" },
  { fr:"C’est trop cher", phon:"hada ghali bezzaf", ar:"هادا غالي بزاف" },
  { fr:"C’est ma première fois", phon:"hadi lewwla merra", ar:"هادي اللولا مرة" } ]},
{ id:"x14", fr:"Je suis ___", phon:"ana ___", note:"Toi, tu ajoutes un a à la fin de l’adjectif : ferhan devient ferhana.", ex:[
  { fr:"Je suis contente", phon:"ana ferhana", ar:"أنا فرحانة" },
  { fr:"Je suis fatiguée", phon:"ana 3ayyana", ar:"أنا عيانة" },
  { fr:"Je suis rassasiée", phon:"ana chab3ana", ar:"أنا شبعانة" } ]},
...
{ id:"x16", fr:"___ m’a plu", phon:"3jebni ___", ex:[
  ...
  { fr:"J’ai adoré le tajine", phon:"3jebni ttajin", ar:"عجبني الطاجين" },
...
{ id:"x18", fr:"S’il te plaît, ___", phon:"3afak, ___", note:"L’impératif à une femme finit souvent par i : <b>3awdi</b>, <b>hdri</b>, <b>chofi</b>.", ex:[
  { fr:"Passe-moi le pain s’il te plaît", phon:"3afak, 3tini lkhobz", ar:"عافاك عطيني الخبز" },
  { fr:"Répète s’il te plaît", phon:"3afak, 3awdi", ar:"عافاك عاودي" },
  { fr:"Parle doucement s’il te plaît", phon:"3afak, hdri b chwiya", ar:"عافاك هضري بشوية" } ]},
{ id:"x19", fr:"Comment ___ ?", phon:"kifach ___ ?", ex:[
  { fr:"Comment on dit ça ?", phon:"kifach kaygoulou hadi ?", ar:"كيفاش كيقولو هادي؟" },
  { fr:"Comment on y va ?", phon:"kifach nemchiw l temma ?", ar:"كيفاش نمشيو لتما؟" },
  { fr:"Comment tu fais ça ?", phon:"kifach katdiri hadi ?", ar:"كيفاش كتديري هادي؟" } ]},
{ id:"x20", fr:"Comme ___", phon:"b7al ___", note:"Sert à comparer, et c’est une machine à compliments.", ex:[
  { fr:"Tu es comme ma mère", phon:"nti b7al mmi", ar:"نتي بحال مي" },
